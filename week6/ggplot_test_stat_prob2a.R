...
g.test.stat <- g.test.stat + annotate("rect", xmin=2.61, xmax=25.39, ymin=-4.6, ymax=4.6, alpha=.1)
...
g.test.stat <- g.test.stat + annotate("segment", x= 25.5, xend = 40, y=.2, yend=.2, color="blue", size=1.5, arrow=arrow()) +
    annotate("segment", x= 2.48, xend = -4, y=.2, yend=.2, color="blue", size=1.5, arrow=arrow()) +
