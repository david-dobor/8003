...
postscript("../gibbs_1.eps",horizontal=FALSE)
...
postscript("../gibbs_2.eps",horizontal=FALSE)
...
postscript("../gibbs_3.eps",horizontal=FALSE)
plot( theta.post[1,], theta.post[2,])
dev.off()


###### ADDED BY ME ######
#if you wanna do inference
mean(theta.post[1,])
#### END ADDED BY ME ####

postscript("../gibbs_4.eps",horizontal=FALSE)
