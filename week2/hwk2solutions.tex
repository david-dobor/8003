...
That is, $Y$ has to be uniformly distributed over $[0, 1]$. %: $Y \tilda U[0, 1]$.
...
\begin{enumerate}
\item Compute the \texttt{cdf} of $X$, $F(X)$. This is simply $u = F(x) = 3x^2$ on the interval from $[0,1]$ ( and it's $1$ whenever $x \geq 1$ and $0$ whenever $x \leq 0$)
